...
function isNumberValidationOptions(validationOptions) {
    ...
    export function IsPositiveValidationOptions(validationOptions) {
        return {
            message: 'El numero $property debe ser positivo'
        };
    }
    ;
    export function IsIntValidationOptions(validationOptions) {
        return {
            message: 'La propiedad $property debe ser entero'
        };
    }
    ;
    export function IsArrayValidationOptions(validationOptions) {
        return {
            message: 'La propiedad  $property debe ser matriz'
        };
    }
    ;
    export function ArrayValidationOptions(validationOptions) {
        return {
            message: 'La propiedad  $property debe ser matriz'
        };
    }
